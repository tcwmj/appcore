package org.yiwan.appcore.bmproxy;
...
public class TimestampWriter {
    ...
    public void write(AppiumCapabilities appiumCapabilities) {
//        String sql = String.format("insert ignore into DIM_CLIENT_ENV (client_os,client_os_version,client_browser_type,client_browser_version,client_resolution) values ('%s','%s','%s','%s','%s');%n", appiumCapabilities.getOs(), appiumCapabilities.getOsVersion(), appiumCapabilities.getBrowser(), appiumCapabilities.getBrowserVersion(), appiumCapabilities.getResolution());
//        write(sql);
    }
    ...
    public void write(ITest testcase) {
        write(testcase.getAppiumCapabilities());
